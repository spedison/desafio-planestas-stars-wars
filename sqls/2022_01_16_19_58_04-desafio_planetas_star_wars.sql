...
INSERT INTO `tb_clima` (`id`, `ativo`, `nome`, `viavel_para_vida`) VALUES (1,'','Ameno',''),(2,'','Quente',''),(3,'','Frio',''),(4,'','Excessivamente Frio (menos de -90oC)','\0'),(7,'\0','Muito Muito Calor Mesmo [SQN33]',''),(8,'','Muito Calor (Mais que 60oC)','\0'),(11,'','Muito Muito Calor Mesmo  [SQN55]',''),(12,'','Outro Clima',''),(14,'\0','Outro Clima 2',''),(15,'','Outro Clima 3',''),(16,'','Outro Clima 5',''),(17,'','Muito Calor (Mais que 60oC) 22','\0'),(26,'','Ameno - Tropical',''),(27,'','Quente Tropical 34',''),(28,'','Tropical - Com chuvas fortes - Monções',''),(31,'','Muito Calor (Mais que 60oC) 222','\0'),(33,'','Outro terreno 100','\0'),(34,'','Outro terreno 101','\0'),(37,'','Exremamente Frio','');
...
INSERT INTO `tb_planeta` (`id`, `ativo`, `nome`) VALUES (1,'','Mercúrio'),(6,'','Terra'),(17,'','Venus'),(19,'','Marte'),(20,'','Júpiter'),(21,'','Saturno'),(22,'','Urano'),(23,'','Netuno'),(24,'','Plutão'),(26,'','Venus 33'),(28,'','Nome Atualizado Venus 44');
...
INSERT INTO `tb_terreno` (`id`, `ativo`, `nome`, `trafegavel`) VALUES (1,'\0','Outro terreno 55','\0'),(2,'\0','Arenoso sem dunas',''),(3,'','Arenoso com dunas',''),(4,'','Muito Arenoso com ou sem dunas','\0'),(5,'','Argila batida - plano',''),(6,'','Outro Tropical 33',''),(8,'','Argila batida - plano 2',''),(9,'','Barranco Largo',''),(12,'','Planalto',''),(13,'','Savanas',''),(14,'','Montanhoso',''),(15,'','Outro terreno 101','\0'),(17,'','Outro terreno 102','\0'),(20,'','Outro terreno 103','\0');
...
/*!50001 VIEW `vw_planetas` AS select `p`.`id` AS `id`,`p`.`ativo` AS `ativo`,`p`.`nome` AS `nome`,`r`.`nome` AS `nomeRegiao`,`c`.`nome` AS `nomeClima`,`c`.`viavel_para_vida` AS `viavel_para_vida`,`t`.`nome` AS `nomeTerreno`,`t`.`trafegavel` AS `trafegavel` from (((`tb_planeta` `p` left join `tb_regiao` `r` on(`p`.`id` = `r`.`planeta_id`)) left join `tb_clima` `c` on(`r`.`clima_id` = `c`.`id`)) left join `tb_terreno` `t` on(`t`.`id` = `r`.`terreno_id`)) where `p`.`ativo` = 1 and `r`.`ativo` = 1 and `c`.`ativo` = 1 and `t`.`ativo` = 1 order by `p`.`nome` */;
...
-- Dump completed on 2022-01-16 19:58:04
